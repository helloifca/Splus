...
class Categoris extends React.Component {
    ...
    getTower = () =>{
        ...
        {isMount ?
            fetch(urlApi+'c_product_info/getTower/'+item.db_profile+'/'+item.entity_cd+'/'+item.project_no,{
                method:'GET',
            ...
            <Container style={Style.bgMain}>
                <Header style={Style.navigation}>
                    ...
                    <View style={Style.actionBarMiddle}>
                        <Text style={Style.actionBarText}>{'Choose Cluster / Tower'.toUpperCase()}</Text>
                    </View>
                ...
                <ImageBackground style={Styles.homeBg}>
                    <View style={Styles.section}>
                        ...
                        renderItem={({ item, separators }) => (
                            <TouchableHighlight underlayColor='transparent' onPress={() => this.goTo(item)}>
